...
class ProtocolFines extends StatefulWidget {
  const ProtocolFines({Key? key}) : super(key: key);

  @override
  State<ProtocolFines> createState() => _ProtocolFinesState();
}

class _ProtocolFinesState extends State<ProtocolFines> {
  ...
  Widget textElements(type, controller) {
    return UIElements.customTextField(
      type: type,
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Spaces.horizontal(
          Column(
            children: [
              textElements(enmTextFielType.trafficFineField, protocolNumber),
