...
const getUserSmsCode = "$baseCaparUrl/v2/auth/register";
const confirm_sms = "$baseCaparUrl/v2/auth/confirm-sms";
const login_acces_toke_url = "$baseCaparUrl/v2/auth/login";
const who_i_am = "$baseCaparUrl/v2/user/me";
String getInitUrl =
    "$baseCaparUrl/v2/user/init?ts=${DateTime.now().millisecondsSinceEpoch}";
const update_user_info = "$baseCaparUrl/v2/user/info";
const getAllFines = '$baseCaparUrl/v2/info/pygg/';
const getBusStantionsUrl = "$baseCaparUrl/v2/pay/bus-stations";
const createPayUrl = "$baseCaparUrl/v2/pay/add";
